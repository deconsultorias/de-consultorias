...
export const Card: React.FC<{
  ...
  return (
    <article
      className={cn(
        'group border border-border rounded-lg overflow-hidden bg-card hover:cursor-pointer transition-all duration-300 hover:border-accent/50 hover:-translate-y-1 hover:shadow-[var(--shadow-soft)]',
        className,
      )}
      ref={card.ref}
    >
